...
export interface AppState {
  ...
  // UI
  sidebarItem: "dashboard" | "servers" | "groups" | "files" | "terminal" | "scripts" | "snippets" | "ssh-keys" | "nginx" | "database" | "docker";
  ...
  // UI Actions
  setSidebarItem: (item: "dashboard" | "servers" | "groups" | "files" | "terminal" | "scripts" | "snippets" | "ssh-keys" | "nginx" | "database" | "docker") => void;
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  // UI Actions
  setSidebarItem: (item: "dashboard" | "servers" | "groups" | "files" | "terminal" | "scripts" | "snippets" | "ssh-keys" | "nginx" | "database" | "docker") => {
